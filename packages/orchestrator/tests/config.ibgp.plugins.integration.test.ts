...
import type { Action } from '../src/rpc/schema/actions.js'
...
describe('iBGP Config Integration Tests', () => {
  it('should create a peer via applyAction', async () => {
    ...
    const result = await server.applyAction(action as unknown as Action)
  ...
  it('should update a peer via applyAction', async () => {
    ...
    const updateResult = await server.applyAction(updateAction as unknown as Action)
  ...
  it('should delete a peer via applyAction', async () => {
    ...
    const deleteResult = await server.applyAction(deleteAction as unknown as Action)
