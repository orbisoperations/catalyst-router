...
import type { StateProvider } from '../plugins/implementations/route-broadcaster.js'
import { RouteBroadcaster } from '../plugins/implementations/route-broadcaster.js'
...
export class OrchestratorRpcServer extends RpcTarget {
  ...
  constructor(config?: OrchestratorConfig) {
    ...
    // Initialize Plugins
    const plugins: any[] = [new LoggerPlugin()]
    ...
    this.pipeline = new PluginPipeline(
      [routingPlugin, ibgpConfigHandler, ibgpProtocolHandler, ...plugins],
